...
\hypertarget{per-database}{%
\chapter{Per Database}\label{per-database}}
...
\paragraph{SQL Query}\label{genderTableQuery}}
...
Same 6 charts used on the \protect\hyperlink{dataProvenanceCharts}{Provenance} dashboard.
...
Same 6 charts used on the \protect\hyperlink{numInObservationPeriod}{Observation Period} dashboard.
...
Same chart used on the \protect\hyperlink{visitTypeTable}{Visit} dashboard.
...
\hypertarget{data-domains-1}{%
\chapter{Data Domains}\label{data-domains-1}}
...
\hypertarget{data-source-filter-7}{%
\section{Data Source Filter}\label{data-source-filter-7}}
...
\subsection{SQL query}\label{sql-query-33}}

No SQL query, use the sql table \texttt{data\_source} of the \texttt{achilles} database.

\hypertarget{chart-settings-36}{%
\subsection{Chart settings}\label{chart-settings-36}}
...
\section{Average Number of Records per Person}\label{average-number-of-records-per-person-1}}
