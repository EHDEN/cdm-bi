...
```{r totalNumberOfPatients, fig.cap="Settings for creating the Total Number of Patients chart",echo=FALSE, out.width="100%"}
...
```{r networkGrowthByDate, fig.cap="Settings for creating the Network Growth by Date chart",echo=FALSE, out.width="100%"}
...
```{r patientsPerCountry, fig.cap="Settings for creating the Patients per Country chart",echo=FALSE, out.width="100%"}
...
```{r dbsTypesPerCountry, fig.cap="Settings for creating the Database Type per Country chart",echo=FALSE, out.width="100%"}
...
```{r worldMap, fig.cap="Settings for creating the World Map chart",echo=FALSE, out.width="100%"}
...
```{r metaData, fig.cap="Settings for creating the Meta Data chart",echo=FALSE, out.width="100%"}
