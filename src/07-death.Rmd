...
```{r numberOfRecords, fig.cap="Settings for creating the Number of Records chart",echo=FALSE, out.width="100%"}
knitr::include_graphics("images/07-death/02-number_of_records.png")
```
...
```{r deathByYearPerThousandPeople, fig.cap="Settings for creating the Death by Year per Thousand People chart",echo=FALSE, out.width="100%"}
knitr::include_graphics("images/07-death/03-deaths_by_year_per_thousand_people.png")
```
